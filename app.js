...
const Restaurantcardcomponent = ({name, cuisines, avgRating, cloudinaryImageId}) => {
    ...
    <div className="restaurant-card-container m-3 p-3">
        <div className="restaurant-image-container">
            <a href="/">
                <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId} alt="Restaurant" className="restaurant-image" />
            </a>
        </div>
